...
\begin{document}
\title{DP - Tabulation (Bottom-Up)}
\date{}
\maketitle
\quees{Construir una pared de ladrillos 🧱 desde el suelo hacia arriba. 
...
\dichodeotraforma{Tabulation es la técnica de DP basada en Iteración (Bottom-Up). 
...
\end{verbatim}}
\comofunciona{1. Inicializa una tabla (array o matriz) con valores default.
...
\end{lstlisting}
\complejidad{Aspecto        │ Con Tabulation
  ───────────────┼────────────────────────────────────────────
...
\entrevistas{}
\resumen{• Bottom-Up: De lo simple a lo complejo.
