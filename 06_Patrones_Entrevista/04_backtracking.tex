...
\begin{document}
\title{Backtracking (Vuelta Atrás)}
\date{}
\maketitle
\quees{Resolver un laberinto 🌀 con un lápiz. 
...
pero controlada.}
\dichodeotraforma{Backtracking es una técnica algorítmica para resolver problemas de 
...
\end{verbatim}}
\comofunciona{Casi todos los problemas de Backtracking siguen este patrón:
...
\end{lstlisting}
\complejidad{Problema        │ Tiempo Típico │ Razón
  ────────────────┼───────────────┼──────────────────────────────
