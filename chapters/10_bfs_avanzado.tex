...
\begin{verbatim}
MULTI-SOURCE BFS llenando distancias por "ondas" (# = muro)

Grid inicial       Onda 0 (fuentes)   Onda 1            Onda 2
(F = fuente)       encola las 2:      vecinos:          siguientes:
...
Onda 3:            Onda 4:
 0 1 2 3            0 1 2 3
 1 # 3 .            1 # 3 4
 2 . 1 0            2 3 1 0     ← toda celda tiene su distancia mínima
                                 al 'F' más cercano

Como ambas fuentes empiezan en 0, las ondas chocan y cada celda
guarda la menor distancia. Una sola pasada BFS, O(R·C).

0-1 BFS (deque):  peso 0 → push_front (mismo nivel)
                  peso 1 → push_back  (siguiente nivel)
\end{verbatim}
\end{dsacomofunciona}
