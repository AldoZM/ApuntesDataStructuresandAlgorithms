...
\begin{description}
    ...
    \item[O(n²) --- Espacio Cuadrático] Creas una estructura bidimensional (matriz) de n x n. Ejemplo: Una tabla de adyacencia para un grafo denso.
\end{description}
}
...
Crear matriz n x n & O(n²) & Espacio bidimensional \\
\hline
\end{tabular}
}
