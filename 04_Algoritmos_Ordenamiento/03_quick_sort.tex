...
Aunque su peor caso es O(n²), en la práctica es mucho más rápido que 
...
──────────────────────────────────────────────────────────────
  ...
  Worst       │ O(n²)         │ Array ya ordenado + pivot extremo
...
💡 Pivot Selection: Para evitar el peor caso O(n²), menciona que se 
...
• Peor caso O(n²) pero muy raro con buen pivot.
• No es estable.
