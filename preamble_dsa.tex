...
\definecolor{brkGold}{RGB}{255, 215, 0}        % () paréntesis
\definecolor{brkOrchid}{RGB}{218, 112, 214}    % [] corchetes
\definecolor{brkBlue}{RGB}{64, 156, 255}       % {} llaves
\lstdefinestyle{cpp}{
  language=C++,
  ...
  literate=
    ...
    % --- Brackets coloreados (estilo bracket-pair de VS Code) ---
    {(}{{\color{brkGold}(}}1 {)}{{\color{brkGold})}}1
    {[}{{\color{brkOrchid}[}}1 {]}{{\color{brkOrchid}]}}1
    {\{}{{\color{brkBlue}\{}}1 {\}}{{\color{brkBlue}\}}}1,
}
\lstset{style=cpp}
