...
\definecolor{brkGold}{RGB}{255, 215, 0}        % {} llaves (dorado VS Code)
\definecolor{brkOrchid}{RGB}{218, 112, 214}    % [] corchetes (orquídea VS Code)
\lstdefinestyle{cpp}{
  language=C++,
  ...
  literate=
    ...
    % --- Brackets: {} y [] (casi siempre código). () se deja sin color
    %     porque abunda en la prosa (O(n), paréntesis) y se ensucia.
    {[}{{\color{brkOrchid}[}}1 {]}{{\color{brkOrchid}]}}1
    {\{}{{\color{brkGold}\{}}1 {\}}{{\color{brkGold}\}}}1,
}
\lstset{style=cpp}
